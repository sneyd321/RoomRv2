...
public class AnimatedTenantHomeownerSwitchInput extends CompoundButtonInput {

    private LinearLayout layout;

    public AnimatedTenantHomeownerSwitchInput(View view, int compoundButton, int layout) {
        ...
        public void onCheckedChanged(final CompoundButton compoundButton, boolean b) {
            ...
            YoYo.with(Techniques.SlideOutLeft).duration(500).onStart(new YoYo.AnimatorCallback() {
                ...
                public void call(Animator animator) {
                    ...
                    compoundButton.setText("Homeowner");
                }
            }).playOn(layout);
        }
    };
